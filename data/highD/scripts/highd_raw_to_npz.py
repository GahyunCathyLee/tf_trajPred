...
def parse_args() -> Config:
    ...
    # LC/gating params (preprocess-time only)
    ap.add_argument("--t_front", type=float, default=3, help="Front time gate in seconds for dx_time gate")
    ap.add_argument("--t_back", type=float, default=5, help="Back time gate in seconds for dx_time gate")
    ap.add_argument("--vy_eps", type=float, default=0.27, help="Deadzone for yVelocity (m/s) for lc_state")
